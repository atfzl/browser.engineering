...
httpResponse_t *httpResponse_init(const char *rawResponseString) {
  ...
  first_newline = strstr(rawResponseString, "\r\n");
  status_len = first_newline - rawResponseString;
  ...
  second_newline = strstr(first_newline, "\r\n\r\n");
  headers_len = second_newline - first_newline;
  ...
  html_len = (rawResponseString + strlen(rawResponseString) - second_newline);
